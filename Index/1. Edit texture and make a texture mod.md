...
> 6. Change the CAB-string.Go to 'File'>'CABinest(s)'.Now you see some random chars in there.Leave 'CAB-' structure but delete those random chars, then input your randome chars.Or you could just name your CAB-string like 'CAB-mytest'. Here I changed to CAB-myceyeline.
...
> 7. Use 'Save .unity3d As...' to save your own eyeline file.Here I named my file as mt_eyeline_c and saved to /chara.
