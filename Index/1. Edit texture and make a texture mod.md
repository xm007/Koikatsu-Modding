...
> 4. Drag your eyeline from outside to your SB3UGS
> 5. Switch to 'Texture' tab, click 'Add image'.Your eyeline should be added in.
> 6. Change the CAB-string.Go to 'File'>'CABinest(s)'.Now you see some random chars in there.Leave 'CAB-' structure but delete those random chars, then input your randome chars.Or you could just name your CAB-string like 'CAB-mytest'
