...
> 6. Change the CAB-string.Go to 'File'>'CABinest(s)'.Leave 'CAB-' structure but delete those random chars, then input your randome chars.Or you could just rename your CAB-string like 'CAB-mytest'.
